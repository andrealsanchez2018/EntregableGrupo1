...
if (isset($_GET['accionProd'])) { # isset: comprobar que la variable sea diferente a nulo
    ...
    function guardarProducto(){
        ...
        $producto->agregarProducto($nombreProducto, $precio, $imgProducto, $descripcion, $cantidad, $idCategoria, $idSubCategoria, $idEstado,$idUsuario_cre, $idUsuario_mod);
    }
    ...
    function listarProductos(){
        ...
        if ($result != 'error') {
            ...
            foreach ($listaProd as $productoEncontrado) :?>
                <form class="formActualizar" method="POST" action="productos.php?accionProd=actualizarProd" enctype="multipart/form-data">
                    <div class="card">
